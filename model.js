/**
 * model.js - Teachable Machine 모델 관리 및 예측 처리
 */
...
async function loadModel() {
    ...
    try {
        ...
        // 예시: https://teachablemachine.withgoogle.com/models/[MODEL_ID]/
        // 사용자가 입력한 모델 URL 사용
            ...
            try {
                ...
                if (modelJSON && modelJSON.modelTopology) {
                    ...
                    try {
                        ...
                        // 모델 로드 성공 메시지
                        modelStatusElement.textContent = "모델이 성공적으로 로드되었습니다!";
                        ...
                        modelStatusElement.textContent = "웹캠에 액세스할 수 없습니다. 카메라 액세스 권한을 허용해주세요.";
                        modelStatusElement.className = "status-message error";
                    }
                } else {
